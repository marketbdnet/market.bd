...
export const AdminOptionsListView: React.FC<AdminOptionsListViewProps> = ({
  ...
  const additionalAdminOptions: AdminOptionItem[] = [
    ...
    },
    {
      ...
      indexNum: 20,
      labelBn: '🛡️ পেমেন্ট ভেরিফিকেশন ও ট্রানজেকশন যাচাই',
      labelEn: '🛡️ Payment Verification & Approval',
      descBn: 'গ্রাহকদের bKash, Nagad ও Rocket ম্যানুয়াল পেমেন্ট প্রুফ ও TrxID যাচাইকরণ',
      descEn: 'Verify manual bKash, Nagad, and Rocket payments, proofs, and TrxID approval',
      groupId: 'ADDITIONAL',
      groupBn: 'অতিরিক্ত সিস্টেম টুলস',
      groupEn: 'Additional Tools',
      icon: CreditCard,
    ...
    },
    {
      id: 'staff',
      indexNum: 28,
      labelBn: '👥 এডমিন স্টাফ রোলস, পারমিশন ও এক্সেস',
      labelEn: '👥 Staff Roles, Permissions & RBAC',
      descBn: '৯টি বিশেষায়িত রোল, ৩৬টি গ্র্যানুলার পারমিশন ও স্টাফ অ্যাকাউন্টস গভর্ন্যান্স',
      descEn: '9 specialized admin roles, 36 granular permissions, and staff accounts',
      groupId: 'ADDITIONAL',
      groupBn: 'অতিরিক্ত সিস্টেম টুলস',
      groupEn: 'Additional Tools',
      icon: Users,
