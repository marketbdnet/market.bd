      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl sm:rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 w-full max-w-2xl max-h-[92vh] flex flex-col overflow-hidden relative text-slate-900 dark:text-white">
        ...
        <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-white p-4 sm:p-5 flex items-center justify-between border-b border-slate-800 shrink-0">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              ...
              className="bg-red-600 hover:bg-red-700 active:scale-95 text-white font-black text-xs px-3 py-1.5 rounded-xl flex items-center gap-1.5 transition shadow-sm cursor-pointer border border-red-500/50"
        ...
        <div className="flex border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/90 text-xs font-bold shrink-0 overflow-x-auto">
          ...
          <button
            ...
            className="py-3 px-3 text-center transition cursor-pointer border-b-2 border-transparent text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/30 flex items-center justify-center gap-1.5 whitespace-nowrap font-black"
        ...
        <div className="p-3 bg-slate-100/90 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between gap-3 text-xs shrink-0 select-none">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="px-3.5 py-1.5 bg-red-600 hover:bg-red-700 text-white font-black text-xs rounded-xl transition flex items-center gap-1.5 cursor-pointer shadow-xs active:scale-95"
              title={language === 'bn' ? 'অ্যাকাউন্ট থেকে লগআউট করুন' : 'Log Out of Account'}
            >
              <LogOut className="w-3.5 h-3.5" />
