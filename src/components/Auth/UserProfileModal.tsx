            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-1.5 overflow-x-auto pb-1 text-xs font-bold scrollbar-none">
                {[
                  ...
                  { id: 'active', labelBn: 'অনুমোদিত / লাইভ', labelEn: 'Active', count: myAds.filter(a => a.status === 'active').length },
                  { id: 'pending', labelBn: 'অপেক্ষমাণ', labelEn: 'Pending', count: myAds.filter(a => a.status === 'pending').length },
