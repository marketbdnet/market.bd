    ...
    <footer className="bg-slate-900 text-slate-300 pt-12 pb-6 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 py-10">
          ...
          <div>
            <h5 className="text-white font-bold text-sm mb-3">
              {language === 'bn' ? 'সাহায্য ও নীতিমালা' : 'Help & Policies'}
            </h5>
            <ul className="space-y-2 text-xs text-slate-400">
              <li>
                <button onClick={() => setActiveTab('about')} className="hover:text-emerald-400 transition cursor-pointer font-bold text-emerald-400 flex items-center gap-1">
                  <span>🏢 {language === 'bn' ? 'আমাদের সম্পর্কে ও যোগাযোগ' : 'About Us & Contact'}</span>
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('terms')} className="hover:text-amber-400 transition cursor-pointer font-semibold text-slate-300 flex items-center gap-1">
                  <span>📜 {language === 'bn' ? 'ব্যবহারের শর্তাবলী (Terms)' : 'Terms of Service'}</span>
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('privacy')} className="hover:text-sky-400 transition cursor-pointer font-semibold text-slate-300 flex items-center gap-1">
                  <span>🔒 {language === 'bn' ? 'প্রাইভেসি পলিসি (Privacy)' : 'Privacy Policy'}</span>
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('help')} className="hover:text-sky-400 transition cursor-pointer">
                  {language === 'bn' ? 'নিরাপদে কেনাবেচা করার নিয়ম' : 'Safety Guidelines'}
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('help')} className="hover:text-sky-400 transition cursor-pointer">
        ...
        {/* MarketBD Official Comprehensive Safety & Selling Guidelines Section */}
