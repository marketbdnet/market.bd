...
import { PaymentVerificationAdminPanel } from '../components/Admin/PaymentVerificationAdminPanel';
...
export const AdminPage: React.FC = () => {
  ...
  return (
    <div className="py-6 space-y-6">
      ...
      <div className="bg-gradient-to-r from-red-700 via-red-600 to-rose-600 text-white p-6 rounded-3xl shadow-md flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 text-xs flex-wrap">
          ...
          <button
            ...
            className="bg-slate-900 hover:bg-black text-white font-extrabold px-3 py-2.5 rounded-xl border border-slate-800 cursor-pointer transition flex items-center justify-center shadow-sm"
            title="Log Out from Admin Portal"
          >
            <span>{language === 'bn' ? 'লগ আউট' : 'Exit Admin'}</span>
          </button>
        </div>
      </div>
      ...
      {adminTab === 'payment-verification' && <PaymentVerificationAdminPanel />}
