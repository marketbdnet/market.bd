    ...
    <div className="py-6 space-y-6">
      ...
      <div className="bg-gradient-to-r from-pink-800 via-rose-700 to-pink-900 text-white rounded-3xl p-6 shadow-xl flex flex-col sm:flex-row items-center justify-between gap-6 relative">
        ...
        <div className="flex items-center gap-2.5 shrink-0 flex-wrap">
          ...
          <button
            onClick={logout}
            className="bg-red-600/90 hover:bg-red-600 active:scale-95 text-white font-black px-4 py-3 rounded-2xl shadow transition text-xs flex items-center gap-1.5 cursor-pointer border border-red-400/50"
