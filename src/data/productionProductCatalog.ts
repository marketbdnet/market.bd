    ...
    cat.subcategories?.forEach((sub, subIdx) => {
      sub.secondLevelCategories?.forEach((sl, slIdx) => {
        ...
        const ad: Product = {
          ...
          postedAt: new Date(new Date('2026-09-01T10:00:00.000Z').getTime() - (counter * 18 * 60 * 1000)).toISOString(),
          createdAt: new Date(new Date('2026-09-01T10:00:00.000Z').getTime() - (counter * 18 * 60 * 1000)).toISOString(),
